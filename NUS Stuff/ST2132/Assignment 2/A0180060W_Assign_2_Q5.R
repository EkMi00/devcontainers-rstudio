...
lower_1 = round(xy_diff - z_score*sd_p*sqrt(1/n + 1/m), 2)
upper_1 = round(xy_diff + z_score*sd_p*sqrt(1/n + 1/m), 2)
sprintf("95%% two-sample pooled t-interval: [%s, %s]", lower_1, upper_1) #[200.34, 323.65]

#c
lower_2 = round(xy_diff - z_score*sqrt(x_var/n + y_var/m), 2)
upper_2 = round(xy_diff + z_score*sqrt(x_var/n + y_var/m), 2)
