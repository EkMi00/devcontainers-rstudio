...
title('Contour and Path of Iterates (Newton+Line Search) with x0 = [1.2;1.2]');
xlabel('x');
ylabel('y');
...
title('Contour and Path of Iterates (Gradient Descent+Line Search) with x0 = [1.2;1.2]');
xlabel('x');
ylabel('y');
legend('Contour', 'Path of Iterates');
...
title('Contour and Path of Iterates (Newton+Line Search) with x0 = [-1.2;1.0]');
xlabel('x');
ylabel('y');
legend('Contour', 'Path of Iterates');
...
title('Contour and Path of Iterates (Gradient Descent+Line Search) with x0 = [-1.2;1.0]');
xlabel('x');
ylabel('y');
legend('Contour', 'Path of Iterates');